...
interface IClient {
  createUser: IClientCreateUserFunction;
}

export interface IClientCreateUserFunction {
  (request?: IClientCreateUserRequest): Promise<IClientCreateUserResponse>;
}

export interface IClientCreateUserRequest {
  email: string;
  password: string;
}

export interface IClientCreateUserResponse {
  id: string;
}
...
export class Client implements IClient {
  ...
  createUser: IClientCreateUserFunction = async req => {
